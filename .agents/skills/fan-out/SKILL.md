...
---
<!-- cycle:rendered template=skills/fan-out.md.tmpl hash=8153cd7cd0f4 — managed by the-cycle; edit the template, not this file -->
...
**Shared rules in `.agents/skills/DOCTRINE.md` — read it if not already in context.** Leans on §3
