...
const finalChordNotes = notes.filter(n => n.module === 'chords' && n.timingOffset >= 4 * (60/140));
...
if (finalChordNotes.length > 0) {
    ...
    if (hasBb && !hasB) console.log("Result: G MINOR (Authentic)");
    else if (hasB && !hasBb) console.log("Result: G MAJOR (Picardy Third)");
    else console.log("Result: Ambiguous / Other");
