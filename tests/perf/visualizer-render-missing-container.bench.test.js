...
describe('UnifiedVisualizer Missing Container Benchmark', () => {
  ...
  it('benchmarks render loop when container is missing', () => {
    ...
    console.log(`[Missing Container] Rendered ${iterations} frames in ${totalTime.toFixed(2)}ms`);
    console.log(`[Missing Container] Average: ${(totalTime / iterations).toFixed(4)}ms per frame`);
  });
});
