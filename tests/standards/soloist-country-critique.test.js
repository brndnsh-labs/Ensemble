...
describe('Soloist Country Critique', () => {
    ...
    it('should pass an authenticity critique for a 128-bar Country soloist performance', () => {
        const numBars = 128;
        ...
        console.log(`[Note Density]          ${notesPerBar.toFixed(2)} notes/bar (Target: 3.0-12.0)`);
        console.log('------------------------------------\n');

        expect(avgInterval).toBeLessThan(9.0);
        expect(notesPerBar).toBeGreaterThan(3.0);
