...
vi.mock('../../public/state.js', () => {
    const mockState = {
        ...
        playback: { bandIntensity: 0.5, bpm: 120, audio: { currentTime: 0 }, intent: { soloistMod: 0 }, intent: { soloistMod: 0 }, intent: { soloistMod: 0 } },
        arranger: { 
            key: 'C', 
            isMinor: false,
            progression: [],
...
describe('Jazz Standard Test: All The Things You Are (Single Key)', () => {
    
    const rootKey = 'Ab'; // Original Key
