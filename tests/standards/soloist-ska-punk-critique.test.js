...
describe('Soloist Ska-Punk Critique', () => {
    ...
    beforeEach(() => {
        ...
        getState.mockReturnValue({
            ...
            groove: { genreFeel: 'Ska-Punk', pocket: 0 },
    ...
    it('should pass an authenticity critique for a 128-bar Ska-Punk soloist performance', () => {
        const numBars = 128;
        ...
        console.log(`[Melodic Smoothness]    ${avgInterval.toFixed(2)} semitones (Target: <11.0)`);
        console.log(`[Note Density]          ${notesPerBar.toFixed(2)} notes/bar (Target: 2.0-12.0)`);
        console.log('------------------------------------\n');

        expect(avgInterval).toBeLessThan(11.0);
