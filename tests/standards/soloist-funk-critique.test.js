...
describe('Soloist Funk Critique', () => {
    let soloistState;
    ...
    it('should pass an authenticity critique for a 128-bar Funk soloist performance', () => {
        const numBars = 128;
