...
describe('Soloist Neo-Soul Critique', () => {
    let soloistState;
    ...
    beforeEach(() => {
        ...
        getState.mockReturnValue({
            ...
            groove: { genreFeel: 'Neo-Soul', pocket: 0 },
    ...
    it('should pass an authenticity critique for a 128-bar Neo-Soul soloist performance', () => {
        const numBars = 128;
        ...
        console.log('\n--- NEO-SOUL SOLOIST CRITIQUE REPORT ---');
