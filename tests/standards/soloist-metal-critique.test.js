...
describe('Soloist Metal Critique', () => {
    ...
    beforeEach(() => {
        ...
        getState.mockReturnValue({
            ...
            groove: { genreFeel: 'Metal', pocket: 0 },
    ...
    it('should pass an authenticity critique for a 128-bar Metal soloist performance', () => {
        const numBars = 128;
