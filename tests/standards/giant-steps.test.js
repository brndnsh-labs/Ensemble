...
vi.mock('../../public/state.js', () => {
    const mockState = {
        ...
        playback: { bandIntensity: 0.5, bpm: 220, audio: { currentTime: 0 }, intent: { soloistMod: 0 }, intent: { soloistMod: 0 }, intent: { soloistMod: 0 } },
        arranger: { 
            key: 'B', 
            isMinor: false,
            progression: [],
...
describe('Jazz Standard Test: Giant Steps (Single Key)', () => {
    ...
    describe(`Key of ${TEST_KEY}`, () => {
        beforeEach(() => {
            ...
            arranger.sections = [
                { id: 'Main', label: 'Main', value: BASE_PROG }
            ];
            validateProgression();
        });
