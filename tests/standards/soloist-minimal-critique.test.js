...
describe('Soloist Minimal Critique', () => {
    let soloistState;
    ...
    beforeEach(() => {
        ...
        getState.mockReturnValue({
            ...
            groove: { genreFeel: 'Minimal', pocket: 0 },
    ...
    it('should pass an authenticity critique for a 128-bar Minimal soloist performance', () => {
        const numBars = 128;
        ...
        console.log('\n--- MINIMAL SOLOIST CRITIQUE REPORT ---');
        console.log(`[Melodic Smoothness]    ${avgInterval.toFixed(2)} semitones (Target: <10.0)`);
        console.log(`[Note Density]          ${notesPerBar.toFixed(2)} notes/bar (Target: 0.5-8.0)`);
        console.log('------------------------------------\n');

        expect(avgInterval).toBeLessThan(10.0);
        expect(notesPerBar).toBeGreaterThan(0.5);
