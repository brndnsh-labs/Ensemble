...
describe('Soloist Scalar Critique', () => {
    let soloistState;
    ...
    beforeEach(() => {
        ...
        getState.mockReturnValue({
            ...
            groove: { genreFeel: 'Scalar', pocket: 0 },
    ...
    it('should pass an authenticity critique for a 128-bar Scalar soloist performance', () => {
        const numBars = 128;
        ...
        console.log('\n--- SCALAR SOLOIST CRITIQUE REPORT ---');
        console.log(`[Melodic Smoothness]    ${avgInterval.toFixed(2)} semitones (Target: <10.0)`);
        console.log(`[Note Density]          ${notesPerBar.toFixed(2)} notes/bar (Target: 2.0-12.0)`);
        console.log('------------------------------------\n');
