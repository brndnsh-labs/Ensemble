...
describe('Soloist Shred Critique', () => {
    let soloistState;
    ...
    beforeEach(() => {
        ...
        getState.mockReturnValue({
            ...
            groove: { genreFeel: 'Shred', pocket: 0 },
    ...
    it('should pass an authenticity critique for a 128-bar Shred soloist performance', () => {
        const numBars = 128;
        ...
        console.log('\n--- SHRED SOLOIST CRITIQUE REPORT ---');
        console.log(`[Melodic Smoothness]    ${avgInterval.toFixed(2)} semitones (Target: <12.0)`);
        console.log(`[Note Density]          ${notesPerBar.toFixed(2)} notes/bar (Target: 4.0-24.0)`);
        console.log('------------------------------------\n');

        expect(avgInterval).toBeLessThan(12.0);
        expect(notesPerBar).toBeGreaterThan(4.0);
        expect(notesPerBar).toBeLessThan(24.0);
    });
});
