...
vi.mock('../../public/state.js', () => {
    const mockState = {
        ...
        playback: { bandIntensity: 0.5, bpm: 180, audio: { currentTime: 0 }, intent: { soloistMod: 0 }, intent: { soloistMod: 0 }, intent: { soloistMod: 0 } },
        arranger: { 
            key: 'Bb', 
            isMinor: false,
            progression: [],
...
describe('Jazz Standard Test: Rhythm Changes (Single Key)', () => {
