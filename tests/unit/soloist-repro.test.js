            ...
            for (let i = 0; i < steps; i++) {
                ...
                randomSpy.mockImplementation(() => {
                    if (mockState.soloist.isResting) {
                        return 0.1; // Force start
                    }
                    if (mockState.soloist.currentPhraseSteps === 0) {
                        return 0.1; // Force motif replay check
                    }
                    if (mockState.soloist.currentPhraseSteps > 12) {
                        return 0.01; // Force end phrase
                    }
