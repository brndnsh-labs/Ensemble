...
describe('Arranger Utils', () => {
    ...
    it('should unroll short arrangements into multiple iterations', () => {
        const unrolled = unrollArrangement(mockArranger as any, 16); // 16 bars target
    ...
    it('should not unroll arrangements that are already long enough', () => {
        ...
        const unrolled = unrollArrangement(longArranger as any, 64);
    ...
    it('should assign musical roles to unrolled sections', () => {
        const unrolled = unrollArrangement(mockArranger as any, 32); // 8 iterations (32 bars / 4 bars)
