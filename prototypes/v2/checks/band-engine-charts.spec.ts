 ...
 * engine (`?engine=next`), while the default engine still turns it away with its own message.
 */
test('the band engine opens and plays holds, N.C., fermatas and off-grid lengths', async ({
    ...
    // The default engine refuses it with its current message, and nothing is saved.
