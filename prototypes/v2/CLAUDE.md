...
| Bar editing / runtime bridge | `app/measure-editor.tsx`, `lib/form-editing.ts`, `lib/song-meter.ts` (the song's own meter, #1371 — re-fits only bars whose effective meter changes; blocks, never rounds), `lib/runtime.ts` | Preserve authored/runtime separation and stop/load/sync lifecycle |
