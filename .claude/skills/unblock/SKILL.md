...
---
<!-- cycle:rendered template=skills/unblock.md.tmpl hash=2113c959aa25 — managed by the-cycle; edit the template, not this file -->
...
8. **Apply all answers in one batched write** (§7): `node scripts/forgejo-project.mjs batch "<file.json>"` — never a loop.
