...
---
<!-- cycle:rendered template=skills/nightly.md.tmpl hash=1506f0c5c7c8 — managed by the-cycle; edit the template, not this file -->
...
Before the `/scout` phase, ensure `.claude/skills/FILING.md` is in context; read it only if
