...
---
<!-- cycle:rendered template=skills/dep-update.md.tmpl hash=b28ecfbaafb0 — managed by the-cycle; edit the template, not this file -->
...
- **Lockfile drift with nothing outdated:** `npm install` rewrote `package-lock.json` without any
