...
| 3 | [Soloist Expressiveness](epic-3-soloist.md) | 7 | 3 | Highest-risk (most exposed). Zero per-note variation. S1–S3 shipped 2026-05-22 — legato/portamento revived; velocity+intensity→brightness coupling; sustained-note cutoff LFO so held notes breathe. |
