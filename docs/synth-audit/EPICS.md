...
| 5 | [Bass Finishing](epic-5-bass.md) | 5 | 2 | Synthy-but-good — finishing, not a rebuild. S1–S2 shipped 2026-05-22: sub-octave layer, velocity-driven saturation + transient (saw bypasses the saturator). Remaining: animated growl cutoff, NaN guard, humanization. |
