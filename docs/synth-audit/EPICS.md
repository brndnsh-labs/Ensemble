...
**Current position:** Epic 0 complete (7/7, 2026-05-21). Epic 1 (Harmony Voice Rebuild) in progress — **S6 hygiene cleanup shipped 2026-05-21** (1/6). Run order S6 → S5 → S1 → S2 → S3 → S4 (see the epic file's sequencing note). **Next: Epic 1 S5** (Harmony bus character EQ); resume with `/synth-cycle`.
...
| 1 | [Harmony Voice Rebuild](epic-1-harmony.md) | 6 | 1 | "Most toy-ish." Generic soloist skeleton + style switch — needs a real rebuild into named formant voices. Organ branch is good; leave it. S6 hygiene cleanup shipped. |
