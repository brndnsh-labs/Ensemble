...
| 4 | [Drums Polish](epic-4-drums.md) | 8 | 3 | Strongest voice already. Per-hit cymbal variation, velocity→timbre on percussion still ahead. S1 (panner leak) + S2 (un-choke closed hat) + S3 (in-between hi-hat positions — closed↔open continuum, foot-chick, 4 grooves) shipped 2026-05-22. |
