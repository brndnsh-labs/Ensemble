...
| 4 | [Drums Polish](epic-4-drums.md) | 8 | 5 | Strongest voice already. Velocity→timbre on percussion still ahead. S1 (panner leak) + S2 (un-choke closed hat) + S3 (in-between hi-hat positions) + S4 (per-hit cymbal variation pool) + S5 (un-gated ride ping) shipped 2026-05-22. |
