...
| 4 | [Drums Polish](epic-4-drums.md) | 8 | 7 | Strongest voice already. S1–S7 shipped 2026-05-22 (panner leak, un-choke closed hat, in-between hi-hat positions, cymbal variation pool, un-gated ride ping, velocity→timbre hand percussion, voice-specific colored noise). S8 (two-stage decay envelopes) remains. |
