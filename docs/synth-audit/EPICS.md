...
| 3 | [Soloist Expressiveness](epic-3-soloist.md) | 7 | 4 | Highest-risk (most exposed). S1–S4 shipped 2026-05-22 — legato/portamento revived; velocity+intensity→brightness coupling; sustained-note cutoff LFO; coupled 3-way vibrato (pitch+amp+timbre). |
