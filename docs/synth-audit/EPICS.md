...
| 3 | [Soloist Expressiveness](epic-3-soloist.md) | 7 | 1 | Highest-risk (most exposed). Frozen sustains, velocity→loudness-only, zero per-note variation. S1 shipped 2026-05-22 — legato/portamento revived via rhythmic adjacency + soft legato attack. |
