...
| 3 | [Soloist Expressiveness](epic-3-soloist.md) | 7 | 5 | Highest-risk (most exposed). S1–S5 shipped 2026-05-22 — legato/portamento; velocity+intensity→brightness; sustained-note cutoff LFO; coupled 3-way vibrato; seeded per-note timbral humanization. |
