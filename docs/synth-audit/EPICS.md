...
| 3 | [Soloist Expressiveness](epic-3-soloist.md) | 7 | 2 | Highest-risk (most exposed). Frozen sustains, zero per-note variation. S1–S2 shipped 2026-05-22 — legato/portamento revived; velocity+intensity→brightness coupling (the "New Sound" toggle is now audible). |
