...
| 5 | [Bass Finishing](epic-5-bass.md) | 5 | 3 | Synthy-but-good — finishing, not a rebuild. S1–S3 shipped 2026-05-22: sub-octave layer, velocity-driven saturation + transient (saw bypasses the saturator), animated pluck-settle cutoff sweep. Remaining: NaN guard, humanization. |
