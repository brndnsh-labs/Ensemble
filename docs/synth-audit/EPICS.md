...
| 4 | [Drums Polish](epic-4-drums.md) | 8 | 2 | Strongest voice already. In-between positions, velocity→timbre on percussion still ahead. S1 (StereoPannerNode leak) + S2 (un-choke closed hat — `playClosedHatNew`) shipped 2026-05-22. |
