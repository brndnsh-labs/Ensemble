...
| 4 | [Drums Polish](epic-4-drums.md) | 8 | 6 | Strongest voice already. S1 (panner leak) + S2 (un-choke closed hat) + S3 (in-between hi-hat positions) + S4 (per-hit cymbal variation pool) + S5 (un-gated ride ping) + S6 (velocity→timbre hand percussion) shipped 2026-05-22. |
