...
| 4 | [Drums Polish](epic-4-drums.md) | 8 | 1 | Strongest voice already. Un-choke the hat, in-between positions, velocity→timbre on percussion. S1 (StereoPannerNode leak) shipped 2026-05-22 — `onEnded` callback on the shared percussion helpers frees the per-hit panner. |
