...
- [`docs/design/band-engine.md`](design/band-engine.md) — DECISION 2026-09-23: the ground-up band engine (`band/`), v0 rhythm section in four genres behind `?engine=next`.
