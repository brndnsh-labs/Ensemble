...
| S16 (compound drum density across genres) | `grooves/*.ts` audit — rock/metal/country/pop/etc fire kick+snare on every eighth in 6/8 regardless of intensity. Power-ballad feel needs intensity-tapered density driven off `isPulseStart` at low intensity. Promoted from user listening session during S15 cycle (2026-05-27). Opus. ~6h. |
