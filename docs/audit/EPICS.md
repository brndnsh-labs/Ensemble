...
| 6 | [Chord Voicing & Comping Cells](epic-chords-voicing.md) | no | 6 | 5 | Voice leading 2nd pass; sticky comping cells; altered-dominant breadth. S2+S3+S4 shipped 2026-05-17; S1 shipped 2026-05-18 (opt-in only; production wiring deferred); S5 shipped 2026-05-18 (reggae bubble lane removed from chord channel; bubble→harmony filed as follow-up). |
