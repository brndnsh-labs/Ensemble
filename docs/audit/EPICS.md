...
| S16b (compound drum density — kick/snare per-genre) | `grooves/*.ts` kick/snare lanes still fire on `isBeatStart` (every eighth in 6/8). Per-genre intensity ramps differ; reuse S12/S13 pattern. Promoted from S16 audit (2026-05-27). Opus. ~6h. |
