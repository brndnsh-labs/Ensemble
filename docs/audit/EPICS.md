...
| 3 | [Deterministic Phrasing Sweep](epic-deterministic-phrasing.md) | yes | 5 | 4 | Replace bare `Math.random()` with `barIndex`-seeded variation. S3+S4 shipped 2026-05-17. |
