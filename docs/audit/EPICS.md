...
| 7 | [Drum Sound Design & Genre Idiom](epic-drums-idiom.md) | no | 7 | 3 | Crash/Cowbell/Brush wiring; tom vocabulary; entropy floor per genre. S1+S7 shipped 2026-05-17; S2 shipped 2026-05-18 (Cowbell + Brush voices + `KNOWN_SOUND_NAMES` warning). |
