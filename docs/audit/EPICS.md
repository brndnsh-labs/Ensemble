...
| 3 | [Deferred Follow-up Sweep](epic-3-followup-cleanup.md) | 5 | 2 | **Synthesized 2026-05-28** from a one-at-a-time owner triage of the open `FOLLOWUPS.md` items; **reconciled mid-cycle to 5 real stories** (was 12 promoted). Synthesis over-promoted: 6 items were already-shipped at synthesis time, and **7 were CLOSED-ON-ARRIVAL** (S2/S3/S4/S6/S8/S9/S11 — already shipped or closed-no-action by the archived [`epic-followup-drain.md`](../archive/musical-audit-2026-05/epic-followup-drain.md) + Epic 12 S4/S5/S6; the `FOLLOWUPS.md` entries were never marked closed). Shipped: **S1** (funk displacement re-weight), **S5** (odd-meter dub grouping-pulse). Live: **S7** (acoustic 6/8 snare — the one real defect), **S10** (Latin generic 6/8 bell), **S12** (penultimate-bar approach window). All three trace to 2026-05-28 meter cycles. Recurring lesson [[verify-followup-against-source]]: shallow greps matched fix-landed `why:` comments; recency-of-source is the reliable "is it live" signal. |
