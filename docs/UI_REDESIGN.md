...
This plan was authored against the live code on `main` (commit `d0a96a4d`, May 2026). It assumes the cruft removal merged in `cleanup/remove-cruft` (Lars mode, audio analyzer, import parsers) is complete.
