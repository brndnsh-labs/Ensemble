    ...
    takes: [
        ...
        },
        {
            ...
            claims: [
                ...
                ['leadChromaticApproach', 0, 0.7, 'the tune steps into its chords'],
                ['leadPhraseEndsOnChordTone', 0.95, 1, 'phrases come to rest on a chord tone'],
                ['leadLeapShare', 0, 0.06, 'no wide leaps inside a phrase'],
                ['leadRepeatedNotes', 0, 0.05, 'the line moves'],
            ],
        },
        {
            take: { lead: 'solo' },
            claims: [
                ['leadRestShare', 0.2, 0.55, 'the solo breathes between phrases'],
                ...
                ['leadChromaticApproach', 0.5, 0.92, 'half-step approaches and enclosures'],
                ['leadStepShare', 0.6, 0.9, 'mostly stepwise, with arpeggio skips'],
