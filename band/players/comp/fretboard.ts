...
/**
 * Lowest note (MIDI) for the lower voice of each interval: the arranger's table, as
 * `voicing.ts`'s `cost` uses it. Kept here for `bottomLaw`, which makes it binding on the two
 * lowest voices of a grip; the two must agree.
 */
